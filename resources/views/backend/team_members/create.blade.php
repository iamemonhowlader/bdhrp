        ...
        <div class="container-fluid px-4 pt-4 pb-5">
            ...
            <div class="premium-page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="display-6 fw-800 mb-2">Add New Team Member</h1>
                        <p class="fs-6 opacity-90 mb-0">Fill in the details to add a new member to the leadership or coordinators list.</p>
                    </div>
                            ...
                            <form action="{{ route('admin.team-members.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Mohammed Khorshed Alam" required>
                                        @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>

                                    <div class="col-md-12">
                                        <label for="designation" class="form-label">Designation</label>
                                        <input type="text" name="designation" id="designation" class="form-control @error('designation') is-invalid @enderror" value="{{ old('designation') }}" placeholder="e.g. Chairman" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="category" id="category" class="form-select @error('category') is-invalid @enderror" required>
                                            ...
                                            <option value="coordinator" {{ old('category') == 'coordinator' ? 'selected' : '' }}>Coordinator</option>
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <small class="text-muted">Recommended size: 500x600px. Max size: 2MB.</small>
                                        @error('image_file') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>

                                    <div class="col-12 mt-5">
                                        <button type="submit" class="btn btn-submit w-100">
                                            <i class="bi bi-person-plus-fill me-2"></i> Save Team Member
                                        </button>
                                    </div>
                                </div>
                            </form>
