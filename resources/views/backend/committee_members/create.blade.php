            ...
            <div class="premium-page-header">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">Add Member</li>
                    </ol>
                </nav>
                <h1 class="display-6 fw-800 mb-0">Add Team Member</h1>
            </div>

            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="premium-card bg-white p-4 p-md-5">
                        <form action="{{ route('admin.committees.members.store', $committee) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            
                            <div class="row g-4">
                                <div class="col-md-12">
                                    <label class="form-label">Full Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="e.g. Jane Doe" required value="{{ old('name') }}">
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="form-label">Designation</label>
                                    <input type="text" name="designation" class="form-control" placeholder="e.g. Co-Chair" required value="{{ old('designation') }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Category</label>
                                    <input type="text" name="category" class="form-control" placeholder="e.g. Division Leadership" value="{{ old('category', 'Division Leadership') }}">
                                </div>
                                ...
                                <div class="col-12 mt-5 text-end">
                                    ...
                                    <button type="submit" class="btn btn-success rounded-pill px-5 fw-bold">Add Member</button>
                                </div>
                            </div>
                        </form>
                    </div>
