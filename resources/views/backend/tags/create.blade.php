...
@section('title', 'New Tag — ' . config('app.name'))
...
<div class="row">
    <div class="col-lg-8">
        @include('backend.partials.cms-header', [
            'title' => 'New Tag',
            'subtitle' => 'Quick labels for filtering content',
        ...
        <div class="card cms-card border-0 p-4 p-md-5">
            <form action="{{ route('admin.tags.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-primary rounded-pill px-4 fw-bold">Save tag</button>
            </form>
        </div>
    </div>
</div>
